class GroupsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @group.save
        format.html { redirect_to @group, notice: 'Grupo creado correctamente.' }
  ...
  def update
    respond_to do |format|
      if @group.update(group_params)
        format.html { redirect_to @group, notice: 'Grupo actualizado correctamente.' }
  ...
  def destroy
    @group.destroy
    respond_to do |format|
      format.html { redirect_to groups_url, notice: 'Grupo eliminado correctamente.' }
